...
def main():
    ...
    for dir in dirs:
        ...
        for bag_file in bag_files:
            ...
            ax.plot(dfs['/odom']['x'],dfs['/odom']['y'], label='odometria przefiltrowana')
            ...
            axins.plot(dfs['/odom']['x'],dfs['/odom']['y'], label='odometria przefiltrowana')
            ...
            plt.plot(dfs['/odom']['time'],dfs['/odom']['x'], label='odometria przefiltrowana')
            ...
            plt.plot(dfs['/odom']['time'],dfs['/odom']['y'], label='odometria przefiltrowana')
            ...
            plt.plot(dfs['/odom']['time'],dfs['/odom']['th'], label='odometria przefiltrowana')
